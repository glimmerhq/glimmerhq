...
class Member < ApplicationRecord
  ...
  scope :order_name_asc, -> { left_join_users.reorder(Glimmer::Database.nulls_last_order('users.name', 'ASC')) }
  scope :order_name_desc, -> { left_join_users.reorder(Glimmer::Database.nulls_last_order('users.name', 'DESC')) }
  scope :order_recent_sign_in, -> { left_join_users.reorder(Glimmer::Database.nulls_last_order('users.last_sign_in_at', 'DESC')) }
  scope :order_oldest_sign_in, -> { left_join_users.reorder(Glimmer::Database.nulls_last_order('users.last_sign_in_at', 'ASC')) }
