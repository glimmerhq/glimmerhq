...
module AlertManagement
  class Alert < ApplicationRecord
    ...
    def self.reference_valid?(reference)
      reference.to_i > 0 && reference.to_i <= Glimmer::Database::MAX_INT_VALUE
    end
    ...
    def parsed_payload
      strong_memoize(:parsed_payload) do
        Glimmer::AlertManagement::Payload.parse(project, payload, monitoring_tool: monitoring_tool)
      end
    end
    ...
    def hook_data
      Glimmer::DataBuilder::Alert.build(self)
    end
