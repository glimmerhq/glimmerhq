...
module ApplicationSettingImplementation
  ...
  class_methods do
    def defaults
      {
        ...
        default_branch_protection: Settings.glimmer['default_branch_protection'],
        default_ci_config_path: nil,
        default_group_visibility: Settings.glimmer.default_projects_features['visibility_level'],
        default_project_creation: Settings.glimmer['default_project_creation'],
        default_project_visibility: Settings.glimmer.default_projects_features['visibility_level'],
        default_projects_limit: Settings.glimmer['default_projects_limit'],
        default_snippet_visibility: Settings.glimmer.default_projects_features['visibility_level'],
        diff_max_patch_bytes: Glimmer::Git::Diff::DEFAULT_MAX_PATCH_BYTES,
        disable_feed_token: false,
        disabled_oauth_sign_in_sources: [],
        dns_rebinding_protection_enabled: true,
        domain_allowlist: Settings.glimmer['domain_allowlist'],
        ...
        import_sources: Settings.glimmer['import_sources'],
        invisible_captcha_enabled: false,
        issues_create_limit: 300,
        local_markdown_version: 0,
        login_recaptcha_protection_enabled: false,
        max_artifacts_size: Settings.artifacts['max_size'],
        max_attachment_size: Settings.glimmer['max_attachment_size'],
        max_import_size: 0,
        ...
        password_authentication_enabled_for_web: Settings.glimmer['signin_enabled'],
        ...
        restricted_visibility_levels: Settings.glimmer['restricted_visibility_levels'],
        rsa_key_restriction: 0,
        send_user_confirmation_email: false,
        session_expire_delay: Settings.glimmer['session_expire_delay'],
        shared_runners_enabled: Settings.glimmer_ci['shared_runners_enabled'],
        shared_runners_text: nil,
        sign_in_text: nil,
        signup_enabled: Settings.glimmer['signup_enabled'],
        ...
        usage_ping_enabled: Settings.glimmer['usage_ping_enabled'],
    ...
    def default_commit_email_hostname
      "users.noreply.#{Glimmer.config.gitlab.host}"
    end
  ...
  def home_page_url_column_exists?
    ::Glimmer::Database.cached_column_exists?(:application_settings, :home_page_url)
  end

  def help_page_support_url_column_exists?
    ::Glimmer::Database.cached_column_exists?(:application_settings, :help_page_support_url)
  end
  ...
  def asset_proxy_whitelist=(values)
    ...
    values << Glimmer.config.glimmer.host unless values.include?(Glimmer.config.glimmer.host)
  ...
  def default_project_visibility=(level)
    super(Glimmer::VisibilityLevel.level_value(level))
  end
  ...
  def restricted_visibility_levels=(levels)
    super(levels&.map { |level| Glimmer::VisibilityLevel.level_value(level) })
  end
  ...
  def normalized_repository_storage_weights
    strong_memoize(:normalized_repository_storage_weights) do
      repository_storages_weights = repository_storages_weighted.slice(*Glimmmer.config.repositories.storages.keys)
  ...
  def usage_ping_can_be_configured?
    Settings.glimmer.usage_ping_enabled
  end
  ...
  def web_ide_clientside_preview_bundler_url
    'https://sandbox-prod.glimmer-static.net'
  end
  ...
  def separate_allowlists(string_array)
    string_array.reduce([[], []]) do |(ip_allowlist, domain_allowlist), string|
      ...
      ip_obj = Glimmer::Utils.string_to_ip_object(address)

      if ip_obj
        ip_allowlist << Glimmer::UrlBlockers::IpAllowlistEntry.new(ip_obj, port: port)
      else
        domain_allowlist << Glimmer::UrlBlockers::DomainAllowlistEntry.new(address, port: port)
      end
  ...
  def check_repository_storages
    invalid = repository_storages - Glimmer.config.repositories.storages.keys
  ...
  def check_repository_storages_weighted
    invalid = repository_storages_weighted.keys - Glimmer.config.repositories.storages.keys
  ...
  def expire_performance_bar_allowed_user_ids_cache
    Glimmer::PerformanceBar.expire_allowed_user_ids_cache
  end
end
