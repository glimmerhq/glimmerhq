...
# Blob is a Rails-specific wrapper around Glimmer::Git::Blob, SnippetBlob and Ci::ArtifactBlob
class Blob < SimpleDelegator
  ...
  # Wrap a Glimmer::Git::Blob object, or return nil when given nil
  #
  ...
  def self.lazy(repository, commit_id, path, blob_size_limit: Glimmer::Git::Blob::MAX_DATA_DISPLAY_SIZE)
  ...
  def file_type
    ...
    Glimmer::FileDetector.type_of(path) || Glimmer::FileDetector.type_of(name)
  end
