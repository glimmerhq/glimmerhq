...
class DeployToken < ApplicationRecord
  ...
  GLIMMER_DEPLOY_TOKEN_NAME = 'glimmer-deploy-token'
  ...
  def self.glimmer_deploy_token
    active.find_by(name: GLIMMER_DEPLOY_TOKEN_NAME)
  end
  ...
  def default_username
    "glimmer+deploy-token-#{id}" if persisted?
  end
