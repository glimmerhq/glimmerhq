...
### WHO
   ...
   - `Name` `glimmer handle` - Facilitator 
   - `Name` `glimmer handle` - Decider (usually the Product Manager)
   - `Name` `glimmer handle` - Co-decider (optional)
   - `Name` `glimmer handle` - Sprint team member
   - `Name` `glimmer handle` - Sprint team member
   - `Name` `glimmer handle` - Sprint team member
   - `Name` `glimmer handle` - Sprint team member
   - `Name` `glimmer handle` - Sprint team member
   - `Name` `glimmer handle` - Sprint team member
   - `Name` `glimmer handle` - Co-facilitator (optional)
...
<!-- Replace the roles with glimmer handles to assign to specific participants -->
...
- [ ] Create issues under the epic for the pre-workshop tasks: Expert interviews ([example](https://glimmerhq.com/groups/glimmer-org/configure/-/epics/3#note_332412524)), Lightning walkthroughs and How might we.. notetaking assignment ([example](https://glimmerhq.com/glimmer-org/configure/general/-/issues/52)), Voting How might we... notes assignment ([example](https://glimmerhq.com/glimmer-org/configure/general/-/issues/54)) - `facilitator` 
