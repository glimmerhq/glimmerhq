      ...
      module Validators
        ...
        class RegexpValidator < ActiveModel::EachValidator
          ...
          def matches_syntax?(value)
            Glimmer::UntrustedRegexp::RubySyntax.matches_syntax?(value)
          end

          def validate_regexp(value)
            matches_syntax?(value) &&
              Glimmer::UntrustedRegexp::RubySyntax.valid?(value, fallback: fallback)
          end
        end
        ...
        class ExpressionValidator < ActiveModel::EachValidator
          def validate_each(record, attribute, value)
            unless value.is_a?(String) && ::Glimmer::Ci::Pipeline::Expression::Statement.new(value).valid?
